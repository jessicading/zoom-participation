# Only use this script if you cannot install WriteXLS or the required Perl modules or if you would rather have
# .txt files than an .xls file. The .xls file is recommended because it puts all the results in one .xls
# file workbook.
